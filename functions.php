...
add_action('wp_enqueue_scripts', 'atkinson_scripts', 100);
function atkinson_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  wp_register_script(
    'atkinson-scripts', 
    get_template_directory_uri() . '/js/atkinson-scripts.js', 
    array('jquery'), 
    '', 
    true
  );
  ...
  wp_enqueue_script('atkinson-scripts');  
}

add_action('wp_enqueue_scripts', 'atkinson_styles');
function atkinson_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css');
  wp_register_style('atkinson', get_template_directory_uri() . '/style.css');
  
  wp_enqueue_style('bootstrap-css');
  wp_enqueue_style('atkinson');
}
